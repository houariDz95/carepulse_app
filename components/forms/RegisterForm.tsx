    ...
    try {
      const patient = {
        ...
        identificationDocument: values.identificationDocument
          ? formData
          : undefined,
        privacyConstent: values.privacyConsent,
      };
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <CustomFormField 
                ...
                label="Scanned a Identification Document"
                renderSkeleton={(field) => (
                  <FormControl>
